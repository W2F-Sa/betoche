...
const STRIP_REQUEST_HEADERS = new Set([
  ...
  "cf-visitor",
  "true-client-ip",
  // Strip Referer too — by default xhttp clients put a giant
  // x_padding-laden URL in here, which is harmless to the origin
  // but turns into noise that some loggers might capture.
  "referer",
  "origin",
]);
