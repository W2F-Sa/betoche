...
<section class="section">
  <div class="section-title">
    ...
    <a href="/api/feed/schema">API →</a>
  </div>
  <p class="muted small">Live from <code>/api/feed/{session}/{page}</code> — paginates as you scroll.</p>
  <ul class="activity-list" data-activity data-pages="3" aria-live="polite"></ul>
</section>
